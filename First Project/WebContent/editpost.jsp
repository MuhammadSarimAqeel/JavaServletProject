...
<form action="EditPostServlet" method="get" id="edit-post">
<div class="card-header">
<input type="hidden" name="postId" value="<%= p.getPid() %>" >

<h4 class="post-title text-center"><b><input type="text" name="title" value="<%= p.getpTitle() %>"></b></h4>
...
%>
<h6 class="post user info"><%= udao.getUserByUserId(p.getUserid()).getName() %> Posted it on : <%= p.getpDate().toLocaleString() %></h6>
</div>
...
<h6><b>Content:</b></h6>
<p class="post-content"><textarea class="form-control"  name="content" rows="5" cols="12" ><%= p.getpContent() %></textarea></p>
...
<pre style="color: white;"><textarea class="form-control"  name="code" rows="4" cols="12" ><%= p.getpCode() %></textarea></pre>

</div>

</div>

<div class="card-footer text-center" style="background-color: #424242" >
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><textarea rows="3" cols="8" class="form-control" name="user_about" value="<%= user.getAbout()%>"></textarea></td>
...
$(document).ready(function(e){
	...
	$("#edit-post").on("submit" , function(event){
